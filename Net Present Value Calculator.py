...
if NPV > 0:
    print('The project should be accepted!')
elif NPV == 0:
    print ('You should be indifferent in the decision whether to accept or reject the project.')
elif NPV < 0:
    print ('The project should be rejected!')
